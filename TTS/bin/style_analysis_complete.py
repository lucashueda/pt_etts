...
if __name__ == '__main__':
    ...
    MODEL_PATH = "/l/disk1/awstebas/lhueda/github/repo_final/repo_final_final/repo_final_final_final/pt_etts/experiments/gst_3speakers_10tokens4heads_phones_onlyrosana/best_model.pth.tar"
