...
def setup_model(num_chars, num_speakers, num_styles, c, speaker_embedding_dim=None):
    ...
    if c.model.lower() in "tacotron":
        ...
        model = MyModel(num_chars=num_chars,
                        ...
                        num_prosodic_features = c.num_prosodic_features,
                        agg_style_space = c.agg_style_space,
...
def check_config_tts(c):
    ...
    check_argument('gst_num_heads', c['gst'], restricted=True, val_type=int, min_val=1, max_val=10)
