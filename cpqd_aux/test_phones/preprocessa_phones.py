...
df_train.loc[df_train.style_target < inter1, 'style_target'] = 1
df_train.loc[(df_train.style_target >= inter1) & (df_train.style_target < inter2),'style_target'] = 2
df_train.loc[df_train.style_target >= inter2,'style_target'] = 3

df_val.loc[df_val.style_target < inter1,'style_target'] = 1
df_val.loc[(df_val.style_target >= inter1) & (df_val.style_target < inter2),'style_target'] = 2
df_val.loc[df_val.style_target >= inter2,'style_target'] = 3
