...
if __name__ == '__main__':
    ...
    df_train, df_val, speaker_id, speaker_id = train_test_split(df, df['emb_id'], test_size = 0.05, random_state = 42, stratify = df['emb_id'])

    out_train = os.path.join(args.output_directory, 'adriana_train.csv')
    out_val = os.path.join(args.output_directory, 'adriana_val.csv')
