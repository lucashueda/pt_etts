...
if __name__ == '__main__':
                    ...
                    with open(os.path.join(transcript, expected_norm_text_file), encoding = 'latin-1') as f:
                        ...
                        for line in f:
                            ...
                            if(os.path.isfile(expected_wav_file)):
                                ...
                                emb_ids.append(2) # Since we dont have embedding just put that to generate correct format
    ...
    out_train = os.path.join(args.output_directory, 'carlos_train.csv')
    out_val = os.path.join(args.output_directory, 'carlos_val.csv')
